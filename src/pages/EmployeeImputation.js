        ...
        <div className="bg-white shadow rounded-lg p-6 mb-6">
          <form className="space-y-4">
                  ...
                  <div className="absolute top-full left-0 mt-1 w-48 bg-white border rounded shadow-lg p-4">
                    ...
                    <div className="space-y-2">
                      <label className="block">
                        Temps
                        <input type="text" value={duration} onChange={handleDurationChange} className="form-input mt-1 w-full" />
                      </label>
                      <label className="block">
                        Heure
                    ...
                    <div className="flex justify-end mt-4 space-x-2">
                      <button className="px-3 py-1 bg-green-500 text-white rounded" onClick={() => setShowDurationPicker(false)}>Valider</button>
                      <button className="px-3 py-1 bg-gray-300 rounded" onClick={() => setShowDurationPicker(false)}>Annuler</button>
                    </div>
                  </div>
                )}
              </div>
            ...
            <div className="flex space-x-4">
              ...
              <button type="reset" className="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400">Réinitialiser</button>
            </div>
          </form>
        </div>
